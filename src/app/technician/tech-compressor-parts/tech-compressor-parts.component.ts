...
@Component({
  selector: 'app-tech-compressor-parts',
  templateUrl: './tech-compressor-parts.component.html',
  styleUrls: ['./tech-compressor-parts.component.scss']
})
export class TechCompressorPartsComponent implements OnInit {
