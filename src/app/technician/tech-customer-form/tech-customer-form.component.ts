...
@Component({
  selector: 'app-tech-customer-form',
  templateUrl: './tech-customer-form.component.html',
  styleUrls: ['./tech-customer-form.component.scss'],
})
export class TechCustomerFormComponent implements OnInit {
  @Input() customerId = '';
